  ...
  return (
    <BrowserRouter>
      <Routes>
        ...
        쿼리 스트링은 주소의 뒷부분에 ? 문자열 이후 key=value로 값을 정의하며 &로 구분을 하는 형태*/}
        {/* 주로 url파라미터는 ID또는 이름을 사용하여 특정 데이터를 조회할 때 사용하고,
        쿼리스트링은 키워드 검색, 페이지네이션, 정렬 방식 등 데이터 조회에 필요한 옵션을 전달할때 사용
        (근데 꼭 위와 같이 쓰라고 정해진 규칙이 있는 것은 아님)
        
        URL파라미터 예시: http://vibe.naver.com/album/31618044
