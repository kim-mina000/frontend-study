...
console.log(document.body.querySelector('.box').textContent);


// Q18
// 위 코드(Q17)에서 선택한 요소에 클릭(Click) 이벤트를 추가해,
// 클릭 시 'Hello~'를 콘솔 출력하시오!
document.body.querySelector('.box').addEventListener('click', function () {
  console.log(`Hello~`);
});
...
const sps = document.body.querySelectorAll('span');
// console.log(sps);
sps.forEach(function (sp,index) {
  sp.classList.add('hello')
});
